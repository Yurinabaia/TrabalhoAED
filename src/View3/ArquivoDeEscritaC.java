...
public class ArquivoDeEscritaC 
{
	...
	public void escrever(String textoEntrada, String NomeArquivo) throws IOException {
	
		 try {
	            bw = new BufferedWriter(new FileWriter(NomeArquivo + ".txt", true));
