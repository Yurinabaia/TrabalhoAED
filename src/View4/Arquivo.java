...
public class Arquivo {
	...
	public void CriacaoArquivo(String NomeDiretorio, String NomeArquivo) throws IOException 
	{
		...
		if (!file.exists())//Criei a pasta
			file.mkdirs();
		saida = new BufferedWriter(new FileWriter(USER_DIR + SEPARATOR + NomeDiretorio + SEPARATOR + NomeArquivo + ".txt", true));
	}
	...
	public void escrever2(String textoEntrada) throws IOException {
		 ...
		 try {
			 saida = new BufferedWriter(new FileWriter("Eleitores", true));
